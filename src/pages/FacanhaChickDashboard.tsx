...
export default function FacanhaChickDashboard() {
  ...
  const fetchData = async () => {
    setLoading(true);
    try {
      const res = await fetch('https://n8n.trafficsolutions.cloud/webhook/busca-resumos-facanha');
      if (res.ok) {
      ...
      console.error('Erro ao buscar dados Façanha Chick:', err);
    }
    setLoading(false);
  };
  ...
  return (
    <div className="min-h-screen bg-[#050505] text-white p-6 md:p-8">
        ...
        <div>
          <div className="flex items-center gap-3 mb-1">
            ...
            <h1 className="text-2xl md:text-3xl font-bold text-white">
              Painel FAÇANHA CHICK — Resumos & Conversas
            </h1>
          </div>
      ...
      <div className="flex flex-wrap items-center gap-2 mb-6 p-3 bg-white/[0.03] border border-orange-500/20 rounded-xl">
      ...
      <div className="grid grid-cols-2 md:grid-cols-5 gap-4 mb-8">
        {[
          { title: 'Total Resumos', value: total, icon: Users, color: '#f97316' },
          ...
          { title: 'Qual. Vendedor (Média)', value: avgQualidadeVendedor, icon: UserCheck, color: '#f97316' },
        ].map(kpi => (
          <div
            key={kpi.title}
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                              <div>
                                ...
                                {r.proximo_passo_sugerido && (
                                  <div className="mt-4">
                                    <h4 className="text-xs font-semibold text-orange-400 uppercase mb-1 flex items-center gap-1.5">
