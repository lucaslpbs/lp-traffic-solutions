...
export function Footer() {
  return (
    <footer className="lpc-noise bg-[#0a0a0a] text-white relative">
      ...
      <div className="max-w-[1180px] mx-auto px-6 py-16 grid gap-12 md:grid-cols-[1.3fr_1fr_1fr_1.2fr]">
        <div>
          ...
          <p className="text-sm text-white/55 leading-relaxed flex items-start gap-2 mb-4">
            <MapPin className="w-4 h-4 mt-0.5 shrink-0 text-[#c9a227]" />
          ...
          <div className="flex flex-col gap-2.5 text-sm text-white/55">
            <a
              ...
              className="inline-flex items-center gap-2 hover:text-[#e8c968] transition-colors w-fit"
            >
            ...
            <a href="tel:+5511973594659" className="inline-flex items-center gap-2 hover:text-[#e8c968] transition-colors w-fit">
              <Phone className="w-4 h-4 text-[#c9a227]" />
        ...
        <div>
          <h4 className="text-xs font-bold uppercase tracking-[0.15em] text-[#c9a227] mb-4">Navegue</h4>
          <div className="flex flex-col gap-2.5 text-sm text-white/55">
            <a href="/lpccapital#produtos" className="hover:text-[#e8c968] transition-colors w-fit">Produtos</a>
            <a href="/lpccapital#sobre" className="hover:text-[#e8c968] transition-colors w-fit">Sobre nós</a>
            <a href="/lpccapital#parceiros" className="hover:text-[#e8c968] transition-colors w-fit">Parceiros</a>
            <a href="/lpccapital/blog" className="hover:text-[#e8c968] transition-colors w-fit">Blog</a>
            <a href="/lpccapital/simulacao" className="hover:text-[#e8c968] transition-colors w-fit">Simular crédito</a>
          </div>
        </div>

        <div>
          <h4 className="text-xs font-bold uppercase tracking-[0.15em] text-[#c9a227] mb-4">
