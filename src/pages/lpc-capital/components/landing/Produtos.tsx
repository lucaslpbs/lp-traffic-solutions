...
export function Produtos() {
  return (
    <section id="produtos" className="bg-[#f7f3ea] py-24 lg:py-32">
      <div className="max-w-[1180px] mx-auto px-6">
        ...
        >
          <div>
            <span className="text-xs font-bold uppercase tracking-[0.2em] text-[#c9a227]">Produtos</span>
            <h2 className="lpc-serif text-[#0f0e0c] font-semibold text-[clamp(28px,3.4vw,42px)] mt-2 max-w-xl">
        ...
        <div className="grid md:grid-cols-2 gap-8">
          {PRODUTOS.map((produto, i) => (
            <motion.div
              ...
              className="group bg-[#0a0a0a] rounded-3xl overflow-hidden relative"
            >
              ...
              <div className="p-7">
                ...
                <Link
                  ...
                  className="inline-flex items-center gap-1.5 text-sm font-bold text-[#e8c968] hover:text-white transition-colors"
                >
                  Saiba mais
