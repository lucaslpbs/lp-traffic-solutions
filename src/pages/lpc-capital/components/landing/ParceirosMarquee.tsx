  ...
  return (
    <section id="parceiros" className="bg-white py-24 lg:py-28">
      <div className="max-w-[1180px] mx-auto px-6">
        ...
        >
          <span className="text-xs font-bold uppercase tracking-[0.2em] text-[#c99900]">Parceiros</span>
          <h2 className="lpc-display text-[#1d1d1d] font-semibold text-[clamp(26px,3.2vw,38px)] mt-2 mb-4">
            A plataforma multibancos que oferece mais opções para você
          </h2>
          <p className="text-[#1d1d1d]/60 leading-relaxed">
      ...
      <div className="overflow-hidden relative">
        ...
        <div className="lpc-marquee-track flex gap-4 w-max">
          {track.map((banco, i) => (
            <div
              key={`${banco.nome}-${i}`}
              className="shrink-0 w-40 h-24 rounded-xl bg-[#00325b] border border-white/5 flex items-center justify-center px-5 hover:border-[#c99900]/40 transition-colors"
            >
