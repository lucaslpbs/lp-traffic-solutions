 ...
 * Adaptado para as cores padrao do sistema (tokens do tema: background + primary).
 */
export const LampContainer = ({
  ...
  return (
    <div
      className={cn(
        "relative flex h-[500px] flex-col items-center justify-center overflow-hidden bg-background w-full rounded-md z-0",
        className
      )}
    >
